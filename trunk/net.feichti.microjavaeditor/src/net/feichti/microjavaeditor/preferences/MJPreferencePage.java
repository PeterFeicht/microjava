...
public class MJPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
	public MJPreferencePage() {
		super(GRID);
		setPreferenceStore(MicroJavaEditorPlugin.getDefault().getPreferenceStore());
